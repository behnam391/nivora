...
نصب‌کننده تنظیمات، کاربران، پلن‌ها، کارت‌ها، همکاران، سفارش‌ها، توکن‌های پنل و ربات و رسیدها را برمی‌گرداند؛ فقط رکورد DNS دامنه را به IP سرور جدید تغییر دهید.
