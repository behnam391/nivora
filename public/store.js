...
const errorText=code=>({INVALID_ORDER:'اطلاعات سفارش کامل نیست.',INVALID_PAYMENT_AMOUNT:'مبلغ واریز معتبر نیست.',ORDER_NOT_FOUND:'سفارشی با این کد پیدا نشد.',SUBSCRIPTION_NOT_FOUND:'این اشتراک برای تمدید در دسترس نیست.',RECEIPT_REQUIRED:'شماره پیگیری و تصویر رسید هر دو لازم‌اند.',INCOMPLETE_RECEIPT:'شماره پیگیری و تصویر رسید را کامل کنید.',INVALID_RECEIPT:'فرمت تصویر رسید معتبر نیست.',INVALID_RECEIPT_TYPE:'فرمت رسید باید JPG، PNG یا WebP باشد.',RECEIPT_TOO_LARGE:'حجم تصویر باید کمتر از ۴ مگابایت باشد.',RECEIPT_NOT_AVAILABLE:'رسید در دسترس نیست؛ دوباره آپلود کنید.',RECEIPT_ALREADY_USED:'این تصویر رسید قبلاً استفاده شده است.',TOO_MANY_PENDING_ORDERS:'تعداد سفارش‌های در انتظار این شماره تکمیل است.',RECEIPT_RATE_LIMITED:'تعداد آپلودها زیاد بود؛ کمی بعد دوباره تلاش کنید.',RECEIPT_STORAGE_BUSY:'فضای دریافت رسید موقتاً در دسترس نیست.',PAYMENT_CARD_MISSING:'کارت پرداخت هنوز تنظیم نشده است.'}[code]||code||'ارتباط با سرویس برقرار نشد.');
